...
export const metadata: Metadata = {
  title: "Bilas.dev — Kamrujjaman Khan Bilas",
  description:
    "Portfolio of Kamrujjaman Khan Bilas — Software Engineering Student & Full-Stack Developer",
  icons: {
    icon: [
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground font-sans">
        <AmbientBackground />
        <div className="page-shell flex min-h-full flex-1 flex-col">{children}</div>
      </body>
    </html>
  );
}
